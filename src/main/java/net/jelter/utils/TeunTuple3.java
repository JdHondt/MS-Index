...
public class TeunTuple3 {
    ...
    public static Comparator<TeunTuple3> compareByDistance() {
        return Comparator.comparingDouble(a -> a.distance);
    }

    public static Comparator<TeunTuple3> compareByDistanceReversed() {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof TeunTuple3)) {
            return false;
        }
        TeunTuple3 other = (TeunTuple3) o;
