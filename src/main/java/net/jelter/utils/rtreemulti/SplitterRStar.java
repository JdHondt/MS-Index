...
import net.jelter.utils.rtreemulti.geometry.ListPair;
...
public final class SplitterRStar implements Splitter {
    ...
    private SplitterRStar() {
        this.comparator = new ListPairComparator();
    }

    private static class ListPairComparator implements Comparator<ListPair<?>>, Serializable {
        @Override
