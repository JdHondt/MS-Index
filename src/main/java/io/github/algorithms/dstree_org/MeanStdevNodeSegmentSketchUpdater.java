...
public class MeanStdevNodeSegmentSketchUpdater implements INodeSegmentSketchUpdater {
    ...
    public void updateSketch(NodeSegmentSketch nodeSegmentSketch, double[] series, int fromIdx, int toIdx) {
