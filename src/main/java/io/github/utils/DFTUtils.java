...
import io.github.algorithms.msindex.segmentation.Segmentation;
...
import static io.github.utils.Parameters.kMeansClusters;
import static io.github.utils.lib.reverseAndPadd;
...
//            Compute the first f DFT-coefficients of the subsequence.
            ...
            double[][] landmarkDistances = landmarkPortfolios != null ? new double[channels][kMeansClusters] : null;
...
//                Update topk
    ...
    public static Tuple2<double[], LandmarkPortfolio> getQueryDFTs(double[][] query, KMeans[] kMeans) {
        ...
        final double[][] landmarkDistances = new double[channels][kMeansClusters];
...
//        Compute distances to landmarks
    ...
    public static double[][][] getQNorms(double[][] query) {
        ...
        double[][][] qNorms = new double[channels][length][];
